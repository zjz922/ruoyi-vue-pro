...
```bash
# 假设RuoYi项目路径为 ~/ruoyi-vue-pro

# 复制实体类
cp entity/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/entity/

# 复制Mapper接口
cp mapper/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/mapper/

# 复制Mapper XML
cp mapper-xml/*.xml ~/ruoyi-vue-pro/yudao-module-finance/src/main/resources/mapper/finance/

# 复制Service接口和实现
cp service/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/service/
cp service-impl/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/service/impl/

# 复制Controller
cp controller/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/controller/

# 复制VO
cp vo/*.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/vo/

# 复制配置类
cp config/FinanceConfig.java ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/config/

# 合并应用配置
cat config/application-finance.yml >> ~/ruoyi-vue-pro/yudao-server/src/main/resources/application.yml
```
