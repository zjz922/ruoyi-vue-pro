...
cp ruoyi-integration/java-complete/entity/*.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/entity/

# 复制Mapper
cp ruoyi-integration/java-complete/mapper/*.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/mapper/

# 复制Mapper XML
cp ruoyi-integration/java-complete/mapper-xml/*.xml \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/resources/mapper/finance/

# 复制Service
cp ruoyi-integration/java-complete/service/*.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/service/

# 复制Controller
cp ruoyi-integration/java-complete/controller/*.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/controller/

# 复制VO
cp ruoyi-integration/java-complete/vo/*.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/vo/

# 复制配置
cp ruoyi-integration/java-complete/config/FinanceConfig.java \
   ~/ruoyi-vue-pro/yudao-module-finance/src/main/java/com/yudao/module/finance/config/
```
