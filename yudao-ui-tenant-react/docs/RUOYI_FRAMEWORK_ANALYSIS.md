...
### 13. **yudao-module-finance** (财务管理模块) ⭐ 新增
**功能：** 闪电帐PRO 财务系统
- 订单管理、资金流水、商品成本
- 抖店配置、数据同步
- 对账管理、财务分析
...
```
1. 创建 Entity (DO)
   └─ src/main/java/cn/iocoder/yudao/module/finance/dal/dataobject/

2. 创建 Mapper 接口
   └─ src/main/java/cn/iocoder/yudao/module/finance/dal/mysql/

3. 创建 Service 接口和实现
   └─ src/main/java/cn/iocoder/yudao/module/finance/service/

4. 创建 VO 类 (Request/Response)
   └─ src/main/java/cn/iocoder/yudao/module/finance/controller/admin/*/vo/

5. 创建 Controller
   └─ src/main/java/cn/iocoder/yudao/module/finance/controller/admin/
...
- **GitHub** - https://github.com/yudaocode/yudao-vue-pro
- **Gitee** - https://gitee.com/yudaocode/yudao-vue-pro
