...
- Vue3管理员端开发（基于yudao-ui-admin-vue3）
...
Java后端仓库地址：
- **GitHub**：https://github.com/zjz922/ruoyi-vue-pro.git
...
├── yudao-module-bpm/               # 流程管理模块
├── yudao-module-report/            # 报表模块
├── yudao-module-ai/                # AI模块
├── yudao-module-iot/               # 物联网模块
├── yudao-module-member/            # 会员模块
├── yudao-module-finance/           # 财务模块（新增）
