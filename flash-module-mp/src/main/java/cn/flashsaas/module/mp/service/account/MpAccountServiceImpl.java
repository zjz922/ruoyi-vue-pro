package cn.flashsaas.module.mp.service.account;
...
import cn.flashsaas.module.mp.convert.account.MpAccountConvert;
import cn.flashsaas.module.mp.dal.dataobject.account.MpAccountDO;
import cn.flashsaas.module.mp.dal.mysql.account.MpAccountMapper;
import cn.flashsaas.module.mp.enums.ErrorCodeConstants;
...
import static cn.flashsaas.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 flash-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
