package cn.flashsaas.framework.web.config;
...
import cn.flashsaas.framework.web.core.filter.CacheRequestBodyFilter;
import cn.flashsaas.framework.web.core.filter.DemoFilter;
import cn.flashsaas.framework.web.core.handler.GlobalExceptionHandler;
import cn.flashsaas.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YudaoWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "flash.demo", havingValue = "true")
