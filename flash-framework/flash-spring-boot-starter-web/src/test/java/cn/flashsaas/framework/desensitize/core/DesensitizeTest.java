package cn.flashsaas.framework.desensitize.core;

import cn.flashsaas.framework.common.util.json.JsonUtils;
import cn.flashsaas.framework.desensitize.core.annotation.Address;
import cn.flashsaas.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.flashsaas.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.flashsaas.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("FlashSaaS");
        ...
        desensitizeDemo.setRegex("你好，我是FlashSaaS");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("FlashSaaS");
        ...
        assertEquals("FlashSaaS", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "FlashSaaS", replacer = "*")
