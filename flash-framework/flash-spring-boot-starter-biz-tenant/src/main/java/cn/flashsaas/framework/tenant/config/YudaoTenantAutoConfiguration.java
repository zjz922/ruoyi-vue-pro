package cn.flashsaas.framework.tenant.config;

import cn.flashsaas.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.flashsaas.framework.redis.config.YudaoCacheProperties;
import cn.flashsaas.framework.security.core.service.SecurityFrameworkService;
import cn.flashsaas.framework.tenant.core.aop.TenantIgnore;
import cn.flashsaas.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.flashsaas.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.flashsaas.framework.tenant.core.job.TenantJobAspect;
import cn.flashsaas.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.flashsaas.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.flashsaas.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.flashsaas.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.flashsaas.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.flashsaas.framework.tenant.core.service.TenantFrameworkService;
import cn.flashsaas.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.flashsaas.framework.tenant.core.web.TenantContextWebFilter;
import cn.flashsaas.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "flash.tenant", value = "enable", matchIfMissing = true) // 允许使用 flash.tenant.enable=false 禁用多租户
...
public class YudaoTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     YudaoCacheProperties flashCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(flashCacheProperties.getRedisScanBatchSize()));
