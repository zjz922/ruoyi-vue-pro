package cn.flashsaas.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.flashsaas.framework.common.util.json.JsonUtils;
import cn.flashsaas.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${flash.info.base-package}", annotationClass = Mapper.class,
