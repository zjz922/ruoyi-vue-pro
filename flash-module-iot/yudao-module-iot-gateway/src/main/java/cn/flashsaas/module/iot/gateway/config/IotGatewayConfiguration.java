package cn.flashsaas.module.iot.gateway.config;

import cn.flashsaas.module.iot.core.messagebus.core.IotMessageBus;
import cn.flashsaas.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import cn.flashsaas.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import cn.flashsaas.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import cn.flashsaas.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import cn.flashsaas.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import cn.flashsaas.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import cn.flashsaas.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import cn.flashsaas.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import cn.flashsaas.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import cn.flashsaas.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import cn.flashsaas.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import cn.flashsaas.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import cn.flashsaas.module.iot.gateway.service.device.IotDeviceService;
import cn.flashsaas.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
