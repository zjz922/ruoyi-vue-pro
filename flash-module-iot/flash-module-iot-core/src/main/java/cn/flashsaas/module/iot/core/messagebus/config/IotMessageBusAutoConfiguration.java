package cn.flashsaas.module.iot.core.messagebus.config;

import cn.flashsaas.framework.mq.redis.core.RedisMQTemplate;
import cn.flashsaas.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.flashsaas.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.flashsaas.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.flashsaas.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.flashsaas.module.iot.core.messagebus.core.IotMessageBus;
import cn.flashsaas.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.flashsaas.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.flashsaas.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import cn.flashsaas.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.message-bus", name = "type", havingValue = "rocketmq")
     ...
     *
     * @see cn.flashsaas.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "flash.iot.message-bus", name = "type", havingValue = "redis")
