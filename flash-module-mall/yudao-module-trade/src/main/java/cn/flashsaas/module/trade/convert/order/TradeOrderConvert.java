...
import cn.flashsaas.framework.ip.core.utils.AreaUtils;
...
import cn.flashsaas.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.flashsaas.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.flashsaas.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.flashsaas.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.flashsaas.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.flashsaas.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.flashsaas.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.flashsaas.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.flashsaas.module.trade.controller.admin.order.vo.*;
import cn.flashsaas.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.flashsaas.module.trade.controller.app.order.vo.*;
import cn.flashsaas.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.flashsaas.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.flashsaas.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.flashsaas.module.trade.framework.order.config.TradeOrderProperties;
import cn.flashsaas.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.flashsaas.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/flashcode/flash-mall-uniapp/issues/ICY7SJ
