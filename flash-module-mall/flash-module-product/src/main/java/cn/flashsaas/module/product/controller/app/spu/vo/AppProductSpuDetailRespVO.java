package cn.flashsaas.module.product.controller.app.spu.vo;

import cn.flashsaas.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "闪电帐")
    private String name;
