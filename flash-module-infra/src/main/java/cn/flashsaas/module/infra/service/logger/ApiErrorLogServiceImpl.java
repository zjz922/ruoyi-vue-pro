...
import static cn.flashsaas.module.infra.dal.dataobject.logger.ApiErrorLogDO.REQUEST_PARAMS_MAX_LENGTH;
...
public class ApiErrorLogServiceImpl implements ApiErrorLogService {
    ...
    public void createApiErrorLog(ApiErrorLogCreateReqDTO createDTO) {
        ...
        try {
            ...
            // 兜底处理，目前只有 flash-cloud 会发生：https://gitee.com/flashcode/flash-cloud-mini/issues/IC1O0A
