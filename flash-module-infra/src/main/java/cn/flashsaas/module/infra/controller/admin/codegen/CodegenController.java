package cn.flashsaas.module.infra.controller.admin.codegen;
...
import cn.flashsaas.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.flashsaas.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.flashsaas.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.flashsaas.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.flashsaas.module.infra.convert.codegen.CodegenConvert;
...
import cn.flashsaas.module.infra.service.codegen.CodegenService;
...
import static cn.flashsaas.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.flashsaas.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "flash"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "闪电帐")
    })
