...
import cn.flashsaas.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.flashsaas.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.flashsaas.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.flashsaas.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.flashsaas.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.flashsaas.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("flash-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("flash-test");
