...
| 模块 | 包名 | 功能 |
|------|------|------|
| 财务管理 | com.flash.module.finance | 核心财务功能 |
| 订单管理 | com.flash.module.finance.order | 订单相关功能 |
| 成本管理 | com.flash.module.finance.cost | 成本配置与管理 |
| 数据同步 | com.flash.module.finance.sync | 第三方API数据同步 |
| 定时任务 | com.flash.module.finance.job | 定时任务调度 |
...
```bash
git clone https://github.com/flashsaas/flash-saas.git
cd flash-saas
```
...
```bash
# 在flash-saas/flash-modules目录下创建财务模块
mkdir -p flash-modules/flash-module-finance

# 创建模块目录结构
cd flash-modules/flash-module-finance
mkdir -p src/main/java/com/flash/module/finance/{controller,service,mapper,entity,dto,vo,api,job}
...
在`flash-modules/flash-module-finance/pom.xml`中添加以下配置：
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <parent>
        ...
        <artifactId>flash-modules</artifactId>
        <version>1.0.0</version>
    </parent>

    <artifactId>flash-module-finance</artifactId>
    <packaging>jar</packaging>
    <name>flash-module-finance</name>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.flash</groupId>
            <artifactId>flash-framework-common</artifactId>
        </dependency>
        <dependency>
            <groupId>com.flash</groupId>
...
将`ruoyi-integration/java/entity/ProductCostDO.java`复制到`flash-modules/flash-module-finance/src/main/java/com/flash/module/finance/entity/ProductCostDO.java`，并根据RuoYi框架规范调整：
...
```java
package com.flash.module.finance.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.flash.module.finance.entity.ProductCostDO;
...
```java
package com.flash.module.finance.service;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.flash.module.finance.dto.ProductCostCreateReqDTO;
import com.flash.module.finance.dto.ProductCostUpdateReqDTO;
import com.flash.module.finance.entity.ProductCostDO;
import com.flash.module.finance.vo.ProductCostVO;
...
```java
package com.flash.module.finance.service.impl;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.flash.framework.common.exception.ServiceException;
import com.flash.module.finance.dto.ProductCostCreateReqDTO;
import com.flash.module.finance.dto.ProductCostUpdateReqDTO;
import com.flash.module.finance.entity.ProductCostDO;
import com.flash.module.finance.entity.ProductCostHistoryDO;
import com.flash.module.finance.mapper.ProductCostMapper;
import com.flash.module.finance.mapper.ProductCostHistoryMapper;
import com.flash.module.finance.service.ProductCostService;
import com.flash.module.finance.vo.ProductCostVO;
import com.flash.module.finance.vo.ProductCostHistoryVO;
...
import com.flash.framework.web.core.util.ServletUtils;
import com.flash.module.finance.dto.ProductCostCreateReqDTO;
import com.flash.module.finance.dto.ProductCostUpdateReqDTO;
import com.flash.module.finance.entity.ProductCostDO;
import com.flash.module.finance.service.ProductCostService;
...
```java
package com.flash.module.finance.job;

import com.flash.module.finance.service.QianchuanSyncService;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.flash.module.finance.api;
...
cp target/flash-module-finance-1.0.0.jar ../../../flash-server/lib/
...
<logger name="com.flash.module.finance" level="INFO" additivity="false">
