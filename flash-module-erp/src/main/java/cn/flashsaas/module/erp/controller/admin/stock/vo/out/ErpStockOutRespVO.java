package cn.flashsaas.module.erp.controller.admin.stock.vo.out;
...
import static cn.flashsaas.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "闪电帐")
    @ExcelProperty("客户名称")
