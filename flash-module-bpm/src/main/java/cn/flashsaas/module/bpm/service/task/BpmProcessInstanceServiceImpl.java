package cn.flashsaas.module.bpm.service.task;
...
import cn.flashsaas.framework.common.util.object.ObjectUtils;
import cn.flashsaas.framework.common.util.object.PageUtils;
import cn.flashsaas.framework.datapermission.core.annotation.DataPermission;
import cn.flashsaas.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.flashsaas.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.flashsaas.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.flashsaas.module.bpm.controller.admin.task.vo.instance.*;
import cn.flashsaas.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.flashsaas.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.flashsaas.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.flashsaas.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.flashsaas.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.flashsaas.module.bpm.enums.ErrorCodeConstants;
import cn.flashsaas.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.flashsaas.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.flashsaas.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.flashsaas.module.bpm.enums.task.BpmReasonEnum;
import cn.flashsaas.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.flashsaas.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.flashsaas.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.flashsaas.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.flashsaas.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.flashsaas.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.flashsaas.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.flashsaas.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.flashsaas.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.flashsaas.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.flashsaas.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.flashsaas.module.bpm.service.message.BpmMessageService;
...
import static cn.flashsaas.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.flashsaas.module.bpm.enums.ErrorCodeConstants.*;
import static cn.flashsaas.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.flashsaas.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/flash-cloud/issues/ID1UYA
