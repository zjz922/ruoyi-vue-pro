package cn.flashsaas.module.ai.service.chat;
...
import cn.flashsaas.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.flashsaas.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.flashsaas.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.flashsaas.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.flashsaas.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.flashsaas.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.flashsaas.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.flashsaas.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.flashsaas.module.ai.dal.dataobject.model.AiModelDO;
import cn.flashsaas.module.ai.dal.dataobject.model.AiToolDO;
import cn.flashsaas.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.flashsaas.module.ai.enums.ErrorCodeConstants;
import cn.flashsaas.module.ai.enums.model.AiPlatformEnum;
...
import cn.flashsaas.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.flashsaas.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.flashsaas.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.flashsaas.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.flashsaas.module.ai.service.model.AiChatRoleService;
import cn.flashsaas.module.ai.service.model.AiModelService;
import cn.flashsaas.module.ai.service.model.AiToolService;
import cn.flashsaas.module.ai.util.AiUtils;
import cn.flashsaas.module.ai.util.FileTypeUtils;
...
import static cn.flashsaas.framework.common.pojo.CommonResult.error;
...
import static cn.flashsaas.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.flashsaas.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 flash.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 flash.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
