package cn.flashsaas.module.system.service.social;
...
import cn.flashsaas.framework.common.util.cache.CacheUtils;
import cn.flashsaas.framework.common.util.http.HttpUtils;
import cn.flashsaas.framework.common.util.object.BeanUtils;
import cn.flashsaas.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.flashsaas.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.flashsaas.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.flashsaas.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.flashsaas.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.flashsaas.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.flashsaas.module.system.dal.dataobject.social.SocialClientDO;
import cn.flashsaas.module.system.dal.mysql.social.SocialClientMapper;
import cn.flashsaas.module.system.dal.redis.RedisKeyConstants;
import cn.flashsaas.module.system.enums.social.SocialTypeEnum;
import cn.flashsaas.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.flashsaas.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.flashsaas.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${flash.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${flash.wxa-subscribe-message.miniprogram-state:formal}")
