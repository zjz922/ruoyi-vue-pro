package cn.flashsaas.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import cn.flashsaas.framework.common.validation.Mobile;
import cn.flashsaas.module.system.framework.operatelog.core.DeptParseFunction;
import cn.flashsaas.module.system.framework.operatelog.core.PostParseFunction;
import cn.flashsaas.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "flash")
    ...
    @Schema(description = "用户邮箱", example = "flash@iocoder.cn")
