package cn.flashsaas.module.system.service.mail;
...
import cn.flashsaas.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.flashsaas.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.flashsaas.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.flashsaas.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.flashsaas.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("闪电帐")));
        // 测试 code 不匹配
