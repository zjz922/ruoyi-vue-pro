package cn.flashsaas.module.system.service.tenant;

import cn.flashsaas.framework.common.enums.CommonStatusEnum;
import cn.flashsaas.framework.common.pojo.PageResult;
import cn.flashsaas.framework.tenant.config.TenantProperties;
...
import cn.flashsaas.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.flashsaas.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.flashsaas.module.system.dal.dataobject.permission.MenuDO;
...
import cn.flashsaas.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.flashsaas.module.system.dal.mysql.tenant.TenantMapper;
import cn.flashsaas.module.system.enums.permission.RoleCodeEnum;
import cn.flashsaas.module.system.enums.permission.RoleTypeEnum;
import cn.flashsaas.module.system.service.permission.MenuService;
import cn.flashsaas.module.system.service.permission.PermissionService;
import cn.flashsaas.module.system.service.permission.RoleService;
import cn.flashsaas.module.system.service.tenant.handler.TenantInfoHandler;
import cn.flashsaas.module.system.service.tenant.handler.TenantMenuHandler;
import cn.flashsaas.module.system.service.user.AdminUserService;
...
import static cn.flashsaas.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("闪电帐", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("闪电帐"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("闪电帐");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
