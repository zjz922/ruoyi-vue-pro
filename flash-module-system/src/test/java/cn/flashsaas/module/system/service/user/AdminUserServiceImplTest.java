package cn.flashsaas.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.flashsaas.framework.common.enums.CommonStatusEnum;
import cn.flashsaas.framework.common.exception.ServiceException;
import cn.flashsaas.framework.common.pojo.PageResult;
import cn.flashsaas.framework.common.util.collection.ArrayUtils;
import cn.flashsaas.framework.common.util.collection.CollectionUtils;
import cn.flashsaas.framework.test.core.ut.BaseDbUnitTest;
import cn.flashsaas.module.infra.api.config.ConfigApi;
import cn.flashsaas.module.infra.api.file.FileApi;
import cn.flashsaas.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.flashsaas.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.flashsaas.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.flashsaas.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.flashsaas.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.flashsaas.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.flashsaas.module.system.dal.dataobject.dept.DeptDO;
import cn.flashsaas.module.system.dal.dataobject.dept.PostDO;
import cn.flashsaas.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.flashsaas.module.system.dal.mysql.dept.UserPostMapper;
import cn.flashsaas.module.system.dal.mysql.user.AdminUserMapper;
import cn.flashsaas.module.system.enums.common.SexEnum;
import cn.flashsaas.module.system.service.dept.DeptService;
import cn.flashsaas.module.system.service.dept.PostService;
import cn.flashsaas.module.system.service.oauth2.OAuth2TokenService;
import cn.flashsaas.module.system.service.permission.PermissionService;
import cn.flashsaas.module.system.service.tenant.TenantService;
...
import static cn.flashsaas.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.flashsaas.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.flashsaas.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.flashsaas.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.flashsaas.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.flashsaas.framework.test.core.util.RandomUtils.*;
import static cn.flashsaas.module.system.enums.ErrorCodeConstants.*;
import static cn.flashsaas.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("flashyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("flashyuanma");
        ...
        assertEquals("flashyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("flashyuanma"))).thenReturn("java");
